...
def main():
    ...
    model = BodyNet(sensing_rate=args.sensing_rate, LayerNo=args.layer_num)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='BodyNet', help='model name')
    ...
    parser.add_argument('--layer_num', type=int, default=14, help='phase number of the Net')
